...
public class HomePageObjects extends BasePage {
    ...
    @FindBy(xpath = "//div[@id='navbarSupportedContent']/ul[1]/li[6]/a[@id='navbarDropdownDashboard']")
    WebElement getTeamsDropdown;

    @FindBy(css = ".dropdown.nav-item.show > div#dashboard-dropdown-menu > a#dashboard-nav-link")
    WebElement getMyTeams;
    ...
    public void clickGetTeamsDropdown() {
        waitForWebElement(getTeamsDropdown);
        getTeamsDropdown.click();
    }
    public void clickGetMyTeams() {
        waitForWebElement(getMyTeams);
        getMyTeams.click();
    }
